...
class SouqspiderSpider(scrapy.Spider):
    ...
    def declare_xpath(self):
        ...
        self.getAllProductsXpath = "//a[@class='img-link quickViewAction sPrimaryLink']/@href"


        self.pageTitleXpath  = "//h2/text()"
        self.categoryXpath = "//div[@class='column column-block block-grid-large single-item']/@data-category-name"
        self.priceXpath = "//span[@class='itemPrice']/@data-price"
